        ...
        <div class="bg-white rounded-lg shadow-lg border border-gray-200">
            <div class="p-8">
                <div class="border-b border-gray-200 pb-6 mb-8">
                    <h2 class="text-2xl font-bold text-gray-900">Edit Note #{{ $note->id }}</h2>
                    <p class="text-gray-600 mt-2">Last updated: {{ $note->updated_at->format('M d, Y \\a\\t g:i A') }}</p>
                </div>
                ...
                <form method="POST" action="{{ route('note.update', $note) }}" class="space-y-6">
                    ...
                    <div class="flex justify-between items-center pt-6 border-t border-gray-200">
                        <div class="flex space-x-3">
                            ...
                            >
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-3"></path>
                            ...
                            <a href="{{ route('note.show', $note) }}" class="inline-flex items-center px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium rounded-lg transition-colors">
                                Cancel
                            </a>
                        </div>
